...
## Get Started
To get the most out of the extension, please set your default Project by using the command palette (Ctrl + Shift + P by default), with the command "Microsoft Foundry: Select Default Project".
